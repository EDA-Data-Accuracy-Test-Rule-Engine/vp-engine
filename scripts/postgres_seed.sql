...
SELECT 'Data seeding completed successfully for PostgreSQL!' as message;
SELECT 'Total employees created: ' || COUNT(*) as summary FROM employees;
SELECT 'Total departments created: ' || COUNT(*) as summary FROM departments;
SELECT 'Total projects created: ' || COUNT(*) as summary FROM projects;